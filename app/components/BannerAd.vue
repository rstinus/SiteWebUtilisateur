  <template>
    <div class="mt-auto pt-10">
      <div v-if="hasConsent" class="bg-gray-50 dark:bg-neutral-800 rounded-2xl p-4 border border-gray-100 dark:border-neutral-700 relative overflow-hidden">
      ...
      <div v-else class="text-[9px] text-center text-gray-400 italic bg-gray-300 dark:bg-neutral-800">
